    ...
    public function run(): void
    {
        ...
        $categories = [
            'charge_fixe' => [
                ...
                'poubelles_sacs' => ['Poubelles et sacs', 15000, 80000],
                'fournitures_bureau' => ['Fournitures de bureau', 20000, 100000],
                'blanchisserie' => ['Blanchisserie', 25000, 120000],
                'conseil' => ['Conseil / honoraires', 50000, 200000],
            ],
            'charge_variable' => [
                ...
                'deplacement_ouvrier' => ['Déplacement ouvrier', 10000, 80000],
                'plomberie' => ['Plomberie', 20000, 150000],
                'activites_pastorales' => ['Activités pastorales', 15000, 200000],
            ],
